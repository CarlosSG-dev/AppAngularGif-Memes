// To parse this data:
//
//   import { Convert, BusquedaGifsRespuesta } from "./file";
//
//   const busquedaGifsRespuesta = Convert.toBusquedaGifsRespuesta(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface BusquedaGifsRespuesta {
    data:       Gif[];
...
export class Convert {
    public static toBusquedaGifsRespuesta(json: string): BusquedaGifsRespuesta {
        return cast(JSON.parse(json), r("BusquedaGifsRespuesta"));
    }

    public static busquedaGifsRespuestaToJson(value: BusquedaGifsRespuesta): string {
        return JSON.stringify(uncast(value, r("BusquedaGifsRespuesta")), null, 2);
    }
}
